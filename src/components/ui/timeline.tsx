  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <h2 className="text-3xl md:text-5xl lg:text-6xl mb-4 text-foreground font-bold max-w-4xl">
          Timeline of <span className="gdg-gradient-text">Events</span>
        </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gdg-gradient rounded-full"
          />
        </div>
      </div>
    </div>

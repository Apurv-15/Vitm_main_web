...
export default function TeamSection() {
  ...
  return (
    <section
      id="team"
      ref={sectionRef}
      className="relative py-32 px-6 overflow-hidden z-30 bg-gradient-to-b from-white via-slate-50 to-white"
    >
      {/* Parallax Shapes */}
      <div
        ref={shape1Ref}
        ...
        >
          {teamMembers.map((member) => (
            <motion.div
              ...
              className="glass-card p-6 text-center group bg-white/40 border-white/20 hover:bg-white/60 transition-all rounded-3xl"
            >
              {/* Avatar */}
              <div

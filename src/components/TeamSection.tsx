...
export default function TeamSection() {
  ...
  return (
    ...
    >
      {/* Background Glow */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-glow-radial opacity-30 pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={titleRef} className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            Meet the <span className="gdg-gradient-text">Leaders</span>
          </h2>
        ...
        >
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Avatar */}
              <div
                className={`w-20 h-20 mx-auto mb-4 rounded-2xl bg-${member.color}/20 border border-${member.color}/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
              >
